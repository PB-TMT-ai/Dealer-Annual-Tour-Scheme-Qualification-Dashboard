# Project: Dealer Annual Tour Scheme Qualification Dashboard
...
- **Data:** Pandas, NumPy
- **Database:** Supabase (if needed) or local CSV/Excel files
- **Styling:** Streamlit native + custom CSS via st.markdown
- **Testing:** pytest
...
/src
  ...
  /hooks       - Data loading and state management utilities
  /lib         - Shared libraries (logger, helpers, config)
